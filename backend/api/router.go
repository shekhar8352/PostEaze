...
func addV1UserAuthRoutes(v1 *gin.RouterGroup) {
	...
	authv1.POST(constants.RefreshRoute, apiv1.RefreshTokenHandler)
	authv1.POST(constants.LogOutRoute, apiv1.LogoutHandler)
...
func addV1CronRoutes(v1 *gin.RouterGroup) {
	...
	cronv1.POST("/trigger-instagram-comments", apiv1.TriggerInstagramCommentsSyncHandler)
}
